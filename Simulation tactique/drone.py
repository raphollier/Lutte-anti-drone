...
class Drone:
    def __init__(self, x, y, width=30, height=20, vitesse=1, color=(0, 255, 0), image=None): # Par défaut: une certaine hauteur/largeur, vitesse, couleur (celles des drones amis)
        """
